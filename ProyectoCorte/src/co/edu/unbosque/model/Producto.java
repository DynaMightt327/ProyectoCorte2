...
public class Producto {
	...
	public String toString() {
		return " Nombre del producto: " + nombreProducto + " Precio: " + precio + " Descripción: " + descripcionProducto
				+ " Cantidad: " + cantidad + " Descuento: " + descuento + " Puntuación: " + puntuacion + " Categoria: "
				+ categoria;
	}
